...
- 2e journée : si on atteint 500 artistes avant le 10 septembre, on ouvre une seconde journée le 29 novembre — et la visibilité passe alors de 50 000 à 100 000 visiteurs. ⚠️ POINT IMPORTANT, à dire clairement dès que le sujet vient (question fréquente) : cette 2e journée est **entièrement INCLUSE dans le prix déjà payé**. Rien à payer en plus, aucun supplément, quel que soit le moment où l'artiste a réservé — et tous les avantages suivent (l'œuvre exposée les deux jours, les photos et vidéos pro, les meetups).
- L'ANGLE À PRIVILÉGIER, bien plus fort que « une journée de plus » : pour chaque artiste DÉJÀ inscrit, la visibilité passe de 50 000 à 100 000 personnes — elle DOUBLE, sans un centime de plus. Formule-le comme ça, c'est concret.
- Conséquence à faire sentir en douceur : inviter d'autres artistes n'est pas un service rendu à ExpoMetro, c'est dans l'intérêt DIRECT de l'artiste lui-même — chaque nouvelle inscription rapproche du cap et double SA propre visibilité. C'est un objectif collectif où tout le monde gagne. Dis-le sans jamais culpabiliser ni insister. Plus on est nombreux, plus l'événement grandit — chaque inscription compte, dont la tienne (invite gentiment l'artiste à participer pour aider à débloquer cette 2e journée).
