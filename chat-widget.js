...
(function () {
  ...
  var T = {
    ...
    it: { name: "Rudolph — ExpoMetro", sub2: "Assistente IA · online", greet: "Ciao 👋 Sono l'assistente IA di Rudolph e posso rispondere a tutte le tue domande su ExpoMetro.\n\nSe non trovi la tua risposta qui, potrai contattare Rudolph direttamente.", ph: "Scrivi la tua domanda…", err: "Ops, si è verificato un errore. Riprova tra poco 🙏", open: "Apri la chat", close: "Chiudi", back: "‹ Indietro", contactChip: "✉️ Scrivi a Rudolph", prompt: "Perfetto! Su cosa vuoi saperne di più?", cIntro: "Lascia la tua email + la tua domanda, Rudolph ti risponderà personalmente 🙏", cEmail: "La tua email", cMsg: "La tua domanda…", cSend: "Invia a Rudolph", cOk: "Grazie! Rudolph ti risponderà molto presto 🙏" },
    de: { name: "Rudolph — ExpoMetro", sub2: "KI-Assistent · online", greet: "Hallo 👋 Ich bin Rudolphs KI-Assistent und kann alle deine Fragen zu ExpoMetro beantworten.\n\nWenn du hier keine Antwort findest, kannst du Rudolph direkt kontaktieren.", ph: "Schreib deine Frage…", err: "Ups, etwas ist schiefgelaufen. Bitte versuche es erneut 🙏", open: "Chat öffnen", close: "Schließen", back: "‹ Zurück", contactChip: "✉️ An Rudolph schreiben", prompt: "Super! Worüber möchtest du mehr erfahren?", cIntro: "Hinterlasse deine E-Mail + deine Frage, Rudolph antwortet dir persönlich 🙏", cEmail: "Deine E-Mail", cMsg: "Deine Frage…", cSend: "An Rudolph senden", cOk: "Danke! Rudolph antwortet dir sehr bald 🙏" }
  };
  var t = T[lang] || T.en;
  ...
  var css = ''
    ...
    + '@media(max-width:480px){#emc-panel{top:0;left:0;right:0;bottom:0;width:auto;height:auto;max-width:none;max-height:none;border-radius:0}#emc-btn{bottom:20px}}';
