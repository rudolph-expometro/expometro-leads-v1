...
(function () {
  ...
  var T = {
    fr: { name: "Rudolph — ExpoMetro", sub2: "Assistant IA · en ligne", greet: "Bonjour 👋 Je suis l'assistant IA de Rudolph, et je peux répondre à toutes tes questions sur ExpoMetro.\n\nSi tu ne trouves pas ta réponse ici, tu pourras contacter Rudolph directement.\n\nPS : il reçoit des centaines de messages d'artistes chaque jour… mais il répond toujours personnellement 😉", ph: "Écris ta question…", err: "Oups, une erreur. Réessaie dans un instant 🙏", open: "Ouvrir le chat", close: "Fermer", back: "‹ Retour", contactChip: "✉️ Écrire à Rudolph", prompt: "Super ! Sur quoi veux-tu en savoir plus ?", cIntro: "Laisse ton email + ta question, Rudolph te répond personnellement 🙏", cEmail: "Ton email", cMsg: "Ta question…", cSend: "Envoyer à Rudolph", cOk: "Merci ! Rudolph te répond très vite 🙏" },
    en: { name: "Rudolph — ExpoMetro", sub2: "AI assistant · online", greet: "Hi 👋 I'm Rudolph's AI assistant, and I can answer all your questions about ExpoMetro.\n\nIf you can't find your answer here, you'll be able to contact Rudolph directly.\n\nPS: he gets hundreds of artist messages every day… but he always replies personally 😉", ph: "Type your question…", err: "Oops, something went wrong. Please try again 🙏", open: "Open chat", close: "Close", back: "‹ Back", contactChip: "✉️ Write to Rudolph", prompt: "Great! What would you like to know more about?", cIntro: "Leave your email + your question, Rudolph will reply personally 🙏", cEmail: "Your email", cMsg: "Your question…", cSend: "Send to Rudolph", cOk: "Thanks! Rudolph will reply very soon 🙏" },
    es: { name: "Rudolph — ExpoMetro", sub2: "Asistente IA · en línea", greet: "¡Hola 👋! Soy el asistente IA de Rudolph y puedo responder a todas tus preguntas sobre ExpoMetro.\n\nSi no encuentras tu respuesta aquí, podrás contactar a Rudolph directamente.\n\nPD: recibe cientos de mensajes de artistas cada día… pero siempre responde personalmente 😉", ph: "Escribe tu pregunta…", err: "Vaya, ha ocurrido un error. Inténtalo de nuevo 🙏", open: "Abrir el chat", close: "Cerrar", back: "‹ Volver", contactChip: "✉️ Escribir a Rudolph", prompt: "¡Genial! ¿Sobre qué quieres saber más?", cIntro: "Deja tu email + tu pregunta, Rudolph te responderá personalmente 🙏", cEmail: "Tu email", cMsg: "Tu pregunta…", cSend: "Enviar a Rudolph", cOk: "¡Gracias! Rudolph te responderá muy pronto 🙏" },
    it: { name: "Rudolph — ExpoMetro", sub2: "Assistente IA · online", greet: "Ciao 👋 Sono l'assistente IA di Rudolph e posso rispondere a tutte le tue domande su ExpoMetro.\n\nSe non trovi la tua risposta qui, potrai contattare Rudolph direttamente.\n\nPS: riceve centinaia di messaggi di artisti ogni giorno… ma risponde sempre personalmente 😉", ph: "Scrivi la tua domanda…", err: "Ops, si è verificato un errore. Riprova tra poco 🙏", open: "Apri la chat", close: "Chiudi", back: "‹ Indietro", contactChip: "✉️ Scrivi a Rudolph", prompt: "Perfetto! Su cosa vuoi saperne di più?", cIntro: "Lascia la tua email + la tua domanda, Rudolph ti risponderà personalmente 🙏", cEmail: "La tua email", cMsg: "La tua domanda…", cSend: "Invia a Rudolph", cOk: "Grazie! Rudolph ti risponderà molto presto 🙏" },
    de: { name: "Rudolph — ExpoMetro", sub2: "KI-Assistent · online", greet: "Hallo 👋 Ich bin Rudolphs KI-Assistent und kann alle deine Fragen zu ExpoMetro beantworten.\n\nWenn du hier keine Antwort findest, kannst du Rudolph direkt kontaktieren.\n\nPS: Er erhält täglich Hunderte Nachrichten von Künstlern… aber er antwortet immer persönlich 😉", ph: "Schreib deine Frage…", err: "Ups, etwas ist schiefgelaufen. Bitte versuche es erneut 🙏", open: "Chat öffnen", close: "Schließen", back: "‹ Zurück", contactChip: "✉️ An Rudolph schreiben", prompt: "Super! Worüber möchtest du mehr erfahren?", cIntro: "Hinterlasse deine E-Mail + deine Frage, Rudolph antwortet dir persönlich 🙏", cEmail: "Deine E-Mail", cMsg: "Deine Frage…", cSend: "An Rudolph senden", cOk: "Danke! Rudolph antwortet dir sehr bald 🙏" }
  };
  var t = T[lang] || T.en;
  ...
  var css = ''
    ...
    + '#emc-in{flex:1;background:#1e242f;border:1px solid rgba(255,255,255,.10);color:#e7ebf2;border-radius:12px;padding:10px 12px;font-size:14px;resize:none;max-height:90px;font-family:inherit;outline:none}'
    ...
    + '@media(max-width:480px){#emc-panel{right:12px;left:12px;width:auto;bottom:164px;height:64vh}}';
  ...
  function callAI(done) {
    ...
    fetch('/api/ask', { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ messages: history.slice(-12), lang: lang, ctx: liveCtx(), profile: current }) })
      ...
      .catch(function () { typing.remove(); addBubble('a', t.err); })
